...
food = {"Hummus and Avocado Sandwich": 5,
        ...
        "Chocolate and Violets": 1}
print(food_orders_app.add_meals_to_shopping_cart('0899999999', **food))
additional_food = {"Risotto with Wild Mushrooms": 1,
...
print(food_orders_app.add_meals_to_shopping_cart('0889999999', **additional_food))

print(food_orders_app.finish_order("0889999999"))
