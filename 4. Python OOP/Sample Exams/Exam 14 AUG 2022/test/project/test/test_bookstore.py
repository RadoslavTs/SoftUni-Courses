...
class TestTheApp(unittest.TestCase):
    ...
    def test_sell_success(self):
        ...
        self.assertEqual(self.bookstore.sell_book("yours", 5), "Sold 5 copies of yours")
        self.assertEqual(self.bookstore.availability_in_store_by_book_titles, {"mine": 1, "yours": 0})
        self.assertEqual(self.bookstore.total_sold_books, 5)

    # def test_sell_success(self):
    #     self.bookstore.availability_in_store_by_book_titles = self.books
    #     self.assertEqual(self.bookstore.sell_book("yours", 3), "Sold 3 copies of yours")
    #     self.assertEqual(self.bookstore.total_sold_books, 3)
    #     self.assertEqual(self.bookstore.availability_in_store_by_book_titles, {"mine": 10, "yours": 0})
